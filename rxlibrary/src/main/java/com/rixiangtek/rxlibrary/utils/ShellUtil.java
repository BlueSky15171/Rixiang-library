...
public class ShellUtil {
    ...
    public static String getSystemProperty(String propName) {
        String line = "";
        try {
            CommandResult result = execCommand("getprop " + propName, false, true);
            line = result.responseMsg;
        } catch (Exception e) {
            Log.e("getSystemProperty", e.getMessage(), e);
        }
    ...
    public static CommandResult exec(String commands, boolean needResponse) {
        int result = -1;
